...
echo "Il y a: " . count($tabWord) . "mots dans le dico ! <br>";
...
foreach ($tabWord as $word) {
    ...
    elseif (strpos($word, "w")){
        $wordLettreW++;
    }

    elseif (isset($word[strlen(trim($word)) - 1]) === "q"){
        $wordLettreEnd++;
    }
}

echo "Il y a: " .$word15 . " mots dans le dico à 15 lettres ! <br>";

echo "Il y a: " . $wordLettreW . " mots dans le dico avec la lettre 'W'!<br>";

echo "Il y a: " . $wordLettreEnd . " mots dans le dico qui finnissent avec la lettre 'Q'!<br>";
